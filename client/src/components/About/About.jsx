...
const About = () => {
  return (
    <div className='fondo'>
      <div className>
        <button className='btn-class'><Link to='/home'>Home</Link> </button>
      </div>
      
      <h1 className='titulo-detail'>About me!</h1>
        <div className='containerCv'> 
          <p className='titulo-rating'><strong>Hi!, my name is Nicolas Pavon; and this project was made with the PERN stack </strong></p>
          <br/>
          <p className='titulo-rating'><strong>contact me!</strong></p>
          <br/>
          <br/>
        <div className='img-center'>
      <a className='icon' rel='noreferrer' href='https://www.linkedin.com/in/nicolaspavonprograma/'
            target="_blank">
